...
builder.Services.AddScoped<IRazorpayClient, SdkRazorpayClient>();
...
builder.Services.AddScoped<SubscriptionClock>();
builder.Services.AddSingleton(TimeProvider.System);
builder.Services.AddHostedService<SubscriptionClockHostedService>();
