      ...
      <main id="landing-main" className="landing-main">
        <section className="landing-band landing-hero" aria-labelledby="landing-title">
          <div className="landing-inner landing-inner--hero">
            ...
            <p className="landing-note">For a small company in India. Superadmin provisions the account; you sign in and do the period.</p>
          </div>
        </section>
        ...
        <section className="landing-band landing-band--steps" aria-labelledby="landing-benefits-title">
          <div className="landing-inner">
